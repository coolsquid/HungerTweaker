...
import squeek.applecore.api.hunger.HealthRegenEvent.Regen;
import stanhebben.zenscript.annotations.ZenClass;
import stanhebben.zenscript.annotations.ZenGetter;
import stanhebben.zenscript.annotations.ZenSetter;

@ZenRegister
@ZenClass("mods.hungertweaker.events.RegenEvent")
public class CTRegenEvent implements IPlayerEvent, IEventCancelable {

	private final Regen internal;

	public CTRegenEvent(Regen internal) {
